                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mt-4" style="font-size: 30px">
                                    <label class="form-label" for="exampleFormControlInput1">Автомобиль Марки</label>
                                    <input class="form-check-input" name="brend_check" type="checkbox" id="autoSizingCheck2" >
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
